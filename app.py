...
def wortwhile_smart_contract():
    ...
    # global info_wortwhile
    info_wortwhile["list_file_wortwhile"]={}
    # print(list_tool)
    # print(list_file)
    worthwhite(list_tool, list_file,project_name,info_wortwhile)
    print("owscdsf")
...
def upload_file():
    ...
    if request.method == 'POST':
        if(request.form['type'].lower() == 'file'):
            ...
            filelist = glob.glob(os.path.join(folder_git,'contracts', "*.sol"))
